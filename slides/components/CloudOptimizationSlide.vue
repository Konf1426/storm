...
.rt-nats { background: #11181c; color: #e2e8f0; padding: 0.5rem 0.8rem; border-radius: 6px; text-align: center; border: 2px solid var(--storm-cyan); box-shadow: 0 0 12px rgba(13, 159, 184, 0.25); font-size: 0.6rem; font-weight: 700; }
.rt-nats code { color: var(--storm-cyan); display: block; margin-top: 0.1rem; font-size: 0.55rem; }
...
.bg-dark { background: #11181c; padding: 0.5rem 0; border-radius: 6px; box-shadow: inset 0 2px 10px rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.05); }
...
.mv-label { font-size: 0.75rem; font-weight: 700; color: var(--storm-slate); text-transform: uppercase; letter-spacing: 0.03em; }
.mv-val { font-size: 1.4rem; font-weight: 800; color: var(--storm-ink); font-family: "IBM Plex Mono", monospace; }
.code-font { color: var(--storm-cyan); font-size: 2.2rem; letter-spacing: -0.05em; }
